...
# 🧠 Key Components
## 💡 The LLM BrainGenerates tailored interview questions.Creates structured, detailed feedback on a user's answer.Operates locally on your machine for full control.
